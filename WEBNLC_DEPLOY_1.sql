...
insert  into `history`(`id_history`,`id_team`,`id_soal`,`id`,`condition`,`score_team`,`score_soal`,`time`) values (85,1,8,1,3,'-10','+0','2018-09-07 05:44:00'),(86,1,8,1,1,'+90','-4','2018-09-07 05:46:58'),(87,1,9,1,3,'-10','+0','2018-09-07 05:47:11'),(88,1,9,1,1,'+90','-4','2018-09-07 05:47:23'),(89,1,1,1,3,'-10','+0','2018-09-07 11:44:41'),(90,1,1,1,1,'+30','-1','2018-09-07 11:44:48');
...
insert  into `soal`(`id_soal`,`kode_soal`,`score_soal`,`awal_score`,`difficulty`) values (1,'E01',20,30,'E'),(2,'E02',30,30,'E'),(3,'E03',30,30,'E'),(4,'M01',50,50,'M'),(6,'M03',50,50,'M'),(7,'H01',86,90,'H'),(8,'H02',86,90,'H'),(9,'H03',86,90,'H'),(10,'M04',50,50,'M'),(11,'E04',30,30,'E'),(12,'E05',30,30,'E'),(100,'EDIT',0,0,'C');
...
insert  into `team`(`id_team`,`kode_team`,`name_team`,`score`,`id_group`) values (1,'NLC0001','noob',280,1),(2,'NLC0002','noob1',100,2),(3,'NLC0003','noob2',100,3),(4,'NLC0004','noob3',100,1),(5,'NLC0005','noob4',100,1);
